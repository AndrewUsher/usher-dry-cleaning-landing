...
const splitItems = [
  {
    ...
    smallText: 'Lightning Fast Workflow',
  },
  {
    heading: 'Data-driven insights',
...
const SplitItem = ({heading, imageAlt, imageFill = false, imageSrc,paragraph, smallText}) => {
  return (
      ...
      <div className="container">
        <div className={innerClasses}>
          ...
          <div className={splitClasses}>
            {splitItems.map((splitItem, i) => <SplitItem key={i} {...splitItem} />)}
          </div>
        </div>
      </div>
    </section>
